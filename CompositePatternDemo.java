...
public class CompositePatternDemo {
    public static void main(String[] args) {
        ...
        employeeHashMap.put(1, new Employee("Tusk", "sales", 2000));
        employeeHashMap.put(2, new Employee("Lina", "sales", 1100));
        employeeHashMap.put(3, new Employee("Slark", "sales", 1000));
        employeeHashMap.put(4, new Employee("Grisha", "clerk", 500));
